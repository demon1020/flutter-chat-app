...
class FirestoreConstants{
  ...
  final CollectionReference CHATS_COLLECTION = FirebaseFirestore.instance.collection(CHATS);
  ...
  static const String CHAT_USERS = "chatUsers";
  ...
  static const String LAST_MESSAGE_TIME = "lastMessageTime";
